...
function Education(){
    return (
        <div className="page education">
            <h1 className="page-title">MY ACADEMIC DEGREES</h1>
            ...
            <h1 className="page-title">RELEVANT SELF LEARNING KNOWLEDGE</h1>
            <div className="education-wrapper">
                <div className="education-item">
            ...
            <h1 className="education-title">OTHER CERTIFICATIONS</h1>
            <div className="education-wrapper">
                <div className="education-item">
